...
def config():
    ...
    # datasets = ["coco_korean"] # pretrain
    datasets = ["vqa_v1"] # fine-tuning
    ...
    # Text Setting
    # index error -> change vqav2_label_size
    vqav2_label_size = 634 # 새 데이터 8개 이상 : 634
    max_text_len = 40
    tokenizer = "bert-base-uncased" # "kobert"
    vocab_size = 30522
...
def task_mlm_itm_clip_bert():
    exp_name = "ko_pretrain"
    # datasets = ["coco", "vg", "sbu", "gcc"]
    datasets = ["coco_korean"]
    # datasets = ["vqa_v1"] 
    loss_names = _loss_names({"itm": 1, "mlm": 1})
    batch_size = 4096
    max_epoch = 50 # 10
